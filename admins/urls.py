...
urlpatterns = [
    ...
    path('member-shop/', member_shop, name='member_shop'),
    path('member-social/', member_social, name='member_social'),
    path('member-jobs/', member_jobs, name='member_jobs'),
    path('member-partners/', member_partners, name='member_partners'),
